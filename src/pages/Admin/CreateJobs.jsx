...
export default function CreateJobs() {
  ...
  const handleUpdateJob = async (e) => { e.preventDefault();
        ...
        <div className="max-w-4xl mx-auto">
          <div className="p-8 mt-8 bg-white shadow-md rounded-xl">
            <div className="space-y-4">
              <div className="font-semibold"> Job Title
                <input
                  type="text"
              ...
              <div className="font-semibold"> Description
                <textarea
                  className="w-full px-3 py-2 border rounded-md"
      ...
      <div className="mt-4">
        ...
        <div className="flex items-center justify-end gap-3 mb-4">
          ...
          <div className="relative" ref={dropdownRef}>
            <button onClick={() => setDropdownOpen(!dropdownOpen)} className="flex items-center px-3 py-2 bg-gray-200 border rounded-md">Sort by: {sortOrder} <BiChevronDown className="ml-2" /></button>
              {dropdownOpen && (
       ...
       {/* Job List */}
          ...
          <ul className="mt-4 space-y-2">
            {filteredJobs.length > 0 ? (
              ...
              </div>))) : (<p className="mt-4 text-center text-gray-600">No jobs available</p>)
            }
          </ul>
                ...
                <form onSubmit={handleUpdateJob} className="mt-4 space-y-4">
                  ...
                  <div className="flex justify-between mt-4">
                    <button
                      ...
                      className="px-4 py-2 text-white bg-gray-500 rounded-md hover:bg-gray-600"> Cancel
                    </button>
                    <button
                      type="submit"
                      className="px-4 py-2 text-white bg-blue-600 rounded-md hover:bg-blue-700">  Save Changes
                    </button>
                  </div>
                </form>
              </div>
