...
//   useEffect(() => {
//     fetch("http://localhost:5175/api/Vacancy")
//       .then((response) => {
//         if (!response.ok) {
...
//     try {
//       const response = await fetch(`http://localhost:5175/api/Vacancy/${id}`, {
//         method: "DELETE",
//       });
...
//     try {
//       const response = await fetch(`http://localhost:5175/api/Vacancy/${editVacancy.vacancyId}`, {
//         method: "PUT",
//         headers: {
