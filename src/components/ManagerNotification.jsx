...
const ManagerNotification = ({ notifications, loading, error, onViewAllClick }) => {
  return (
          ...
          notifications.map((n) => (
            <div
              ...
              className={`p-4 border-b hover:bg-gray-50 transition ${
                n.status === 'Admin' || n.type === 'Important' // Assuming these properties exist for styling important notifications
